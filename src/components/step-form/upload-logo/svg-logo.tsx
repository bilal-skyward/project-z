        ...
        >
          ...
          <style>
            {`@font-face {
                ...
                .bottom-icon{
                  transform: scale(0.7) translate(22%, 40%);
                }
                .bottom-text{
                  transform: translate(0,-37%);
                }
                .left-icon{
                  transform: scale(0.5) translate(-15%, 43%);
                }
                .left-text{
                  transform: scale(0.8)translate(30%, 11%);
                }
